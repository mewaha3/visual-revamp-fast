              ...
              <div className="flex flex-col items-center mb-6">
                ...
                {!loading && !error && employerInfo && (
                  <div className="mt-3 text-center">
                    <p className="font-medium">นายจ้าง: {employerInfo.firstName} {employerInfo.lastName}</p>
                    <p className="text-sm text-gray-500">ประเภทงาน: {employerInfo.jobType || 'ไม่ระบุ'}</p>
                  </div>
                )}
              </div>
