...
const Hero = () => {
  return (
    <section className="py-16 md:py-24 overflow-hidden relative">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-200 to-transparent pointer-events-none"></div>
      
      {/* Decorative elements - increased opacity & darker tones */}
      <div className="absolute top-1/3 right-0 w-64 h-64 bg-fastlabor-400 rounded-full filter blur-3xl opacity-90 -z-10"></div>
      <div className="absolute bottom-0 left-1/4 w-72 h-72 bg-blue-300 rounded-full filter blur-3xl opacity-90 -z-10"></div>
      ...
      <div className="container flex flex-col lg:flex-row items-center">
        <div className="flex-1 space-y-8 text-center lg:text-left mb-12 lg:mb-0">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tight text-gray-800">
            ...
            <span className="bg-gradient-to-r from-fastlabor-600 to-fastlabor-400 bg-clip-text text-transparent">
              อย่างรวดเร็ว
            </span>
          </h1>
          ...
          <div className="pt-8 grid grid-cols-3 gap-8 max-w-lg mx-auto lg:mx-0">
            <div className="text-center">
              <p className="text-3xl font-bold bg-gradient-to-r from-fastlabor-700 to-fastlabor-500 bg-clip-text text-transparent">
                1000+
              </p>
